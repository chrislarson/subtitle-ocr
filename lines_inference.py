...
class ImageLinePredictor(OnnxInferenceModel):
...
if __name__ == "__main__":
    ...
    word_model_path = os.path.join("models", "crnn_lines", "configs.yaml")
    df_path = os.path.join(dir_path, "models", "crnn_lines", "val.csv")

    configs = BaseModelConfigs.load(os.path.join(dir_path, word_model_path))
    model = ImageLinePredictor(
